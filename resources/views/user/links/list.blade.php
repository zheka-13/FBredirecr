...
@section('content')
    ...
    <table style="margin: 10px" class="table table-bordered table-striped">
        ...
        <tr>
            <th>#
                <a href = "{{ route("user.links", ["sort" => "id"]) }}"><i class="bi bi-sort-up"></i></a>
            </th>
            <th>{{ __("Link Name") }}
                <i data-toggle="tooltip" data-placement="top" class="help-tip bi bi-question-circle-fill" title="{{ __("The name of the link") }}"></i>
            </th>
            ...
            <th>{{ __("Hits") }}
                <i data-toggle="tooltip" data-placement="top" class="help-tip bi bi-question-circle-fill" title="{{ __("How many times people clicked on this link") }}"></i>
                <a href = "{{ route("user.links", ["sort" => "hits"]) }}"><i class="bi bi-sort-up"></i></a>
            </th>
